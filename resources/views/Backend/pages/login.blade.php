...
<head>
    ...
    <title>CV Generator | Log in</title>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{URL::to('lib/iCheck/square/blue.css')}}">
...
<body style="background-image: url('Uploads/table.jpg');background-position: center;background-repeat: no-repeat;background-size: cover"
      class="hold-transition login-page">

<div class="login-box">
    <div class="login-logo">
        <a href="{{url('/')}}"><b>CV</b> Generator</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        ...
        <form action="{{route('loginAdmin')}}" method="post">
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="checkbox icheck">
                        <label>
                            <input name="remember_me" value="remember_me" type="checkbox"> Remember Me
                        </label>
                    </div>
                </div>
                <!-- /.col -->
            ...
            <div>
                <a href="{{route('resetLink')}}">Forgot your Password?</a>
            </div>
        </form>
        <hr>
        <hr>
