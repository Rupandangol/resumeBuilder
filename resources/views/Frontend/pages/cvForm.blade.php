        ...
        <form id="myDetail" action="{{url('/cvForm')}}" enctype="multipart/form-data" method="post">
            ...
            <div class="box-body">
                ...
                @if($detail)
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-addon">
							<select style="width: 150px" name="countryCode" id="">
								@foreach($countryArray as $key=>$value)
                                    <option @if($detail->countryCode===$value['code']) selected @endif value="{{$value['code']}}">{{$key}}-{{$value['name']}}(+{{$value['code']}})</option>
                                @endforeach
							</select>
						</span>
                        <input type="number" style="height: 37px" name="mobileNo" value="{{$detail->mobileNo}}" class="form-control"
                ...
                @else
                    ...
                    {{----}}
                    {{--for old data--}}
                    @if(old('fullName')||old('email')||old('mobileNo')||old('address')||old('dateOfBirth'))
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-addon">
								<select style="width: 150px;" name="countryCode" id="">
								@foreach($countryArray as $key=>$value)
                                        <option @if(old('countryCode')===$value['code']) selected @endif value="{{$value['code']}}">{{$key}}
                                            -{{$value['name']}}(+{{$value['code']}})</option>
                                    @endforeach
								</select>
							</span>
                            <input type="number" style="height: 37px" name="mobileNo" class="form-control"
                                   value="{{old('mobileNo')??''}}" placeholder=" Mobile Number">
                    ...
                    @else
                        ...
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-phone"></i></span>
                            <span class="input-group-addon">
								<select style="width: 150px;" name="countryCode" id="country">
									@foreach($countryArray as $key=>$value)
